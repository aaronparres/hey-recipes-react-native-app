...
export default class RecipeFavoritesScreen extends React.Component {
    constructor(props){
        super(props);
        this.state = {
            loading: true,
    ...
    getInfo(){
        Axios.get('http://api.yummly.com/v1/api/recipe/'+this.state.info.recipe+'?_app_id=e8db4627&_app_key=4598060826e9e5f129959b618df8f69e')
            .then(res => {
